...
class DDQN:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            e_l1 = tf.contrib.layers.conv2d(inputs=_input, num_outputs=32, kernel_size=8, stride=4, padding="SAME")
            e_l2 = tf.contrib.layers.conv2d(inputs=e_l1, num_outputs=64, kernel_size=4, stride=2, padding="SAME")
